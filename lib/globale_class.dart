...
// ignore: non_constant_identifier_names
  ...
  static Future<String?> aepsPostCall(String data, String? deviceID) async {
    var headers = {
      'deviceid': '$deviceID',
      'Cookie': 'ASP.NET_SessionId=gg5uofsoxsrba1uv0egdcwrg; ASP.NET_SessionId=b4qkrzbfle40tws0hkysbufq'
    };
    var request = http.MultipartRequest('POST', Uri.parse('https://sonitechno.info/api/aeps.aspx'));
    request.fields.addAll({'Request': data});
  ...
  //   };
  //
  //   var aepsRequest = http.MultipartRequest(
  //     'POST', Uri.parse("https://sonitechno.info/api/aeps.aspx"),
  //   );
  //
  //   aepsRequest.fields.addAll({'Aepsrequest': data});
  //
  //   print("AEPS request response >>>>>>>>>>>>>>>>>>>${data}");
  //
  //   aepsRequest.headers.addAll(headers);
  //
  //   http.Response response =
  //   await http.Response.fromStream(await aepsRequest.send());
  //
  //   if (response.statusCode == 200) {
  //     return response.body;
  //   } else {
