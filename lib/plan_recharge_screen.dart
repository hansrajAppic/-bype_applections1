...
import 'Globale_class/circularProgressIndicator_class.dart';
import 'Globale_class/colors.dart';
import 'Globale_class/shardPreferance.dart';
import 'Json_model/getoprater_model.dart';
import 'Json_model/getstate_model.dart';
...
class _PlanRecharge_ScreenState extends State<PlanRecharge_Screen>
  ...
  Future<void> loadData() async {
    ...
    await PlannewapiCall(widget.SearchData["operatorID"].toString(),
...
// Tabbarvew
  ...
  Future<String?> PlannewapiCall(String operatorID, String stateID) async {
    try {
      ...
      if (Mobile != null && Password != null) {
        ...
        String? plannew = await MyGlobalFunctions.PostCall(
          '{"MethodName":"plannew","UserID":"$Mobile","Password":"$Password","OperatorID":"$operatorID","State":" $stateID"}',
          "$deviceID",
        );
